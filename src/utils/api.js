import {fetch, fetchNoloading} from './http'
...
export async function getPartnerInfo (params) {
  let result = await fetch('/Api/h5/u/memberPartner/p/getPartnerInfo', params, 'post')
  return result
}
...
export async function valueCollect (params) {
  let result = await fetch('/Api/h5/u/follow/isFollowGoods', params, 'post')
  return result
}
...
export async function phoneLogin (params) {
  let result = await fetch('Api/h5/user/p/login', params, 'post')
  return result
}
...
// 店铺详情 - 自营/商城 分类列表
export async function getTypeGoodsList (params) {
  let result = await fetch('Api/h5/m/p/actionTypeGoods', params, 'post')
  return result
}
// 店铺详情 - 自营/商城 添加商品
...
export async function getMyAccount (params) {
  let result = await fetchNoloading('Api/h5/u/member/getMyAccount', params, 'post')
  return result
}
// 订单列表
export async function orderList (params) {
...
export async function getFKMState (params) {
  let result = await fetchNoloading('Api/h5/u/member/getFKMState', params, 'post')
  return result
}
...
// 删除店铺浏览足迹
export async function delMemberTrackShop (params) {
  let result = await fetch('/Api/h5/u/memberTarck/delMemberTrackShop', params, 'post')
  return result
}
// 判断绑定情况
export async function getMemberWx (params) {
  let result = await fetch('/Api/Member/getMemberWx', params, 'post')
  return result
}
// 判断绑定情况
export async function getUserSearcHis (params) {
  let result = await fetch('Api/h5/u/search/p/getUserSearcHis', params, 'post')
  return result
}
// 生成分享二维码接口
export async function genSharepic (params) {
  let result = await fetch('Api/h5/small/qr/p/hbShop', params, 'post')
  return result
}

// 获取当前定位
export async function acquiringPersonnelLocation (params) {
  let result = await fetch('/Api/h5/base/area/p/acquiringPersonnelLocation', params, 'post')
  return result
}
// 确认收货接口
export async function confirmOrder (params) {
  let result = await fetch('Api/h5/u/order/confirmOrder', params, 'post')
  return result
}

// 取消订单接口
export async function cancelOrder (params) {
  let result = await fetch('Api/h5/u/order/cancelOrder', params, 'post')
  return result
}

// 再来一单接口
export async function buyAgainOrder (params) {
  let result = await fetch('Api/h5/u/ordercart/reBuyForOrder', params, 'post')
  return result
}
// 删除地址
export async function deleteMemberAddress (params) {
  let result = await fetch('Api/h5/u/memberaddress/deleteMemberAddress', params, 'post')
  return result
}
// 退出登录
export async function logout (params) {
  let result = await fetch('Api/h5/user/p/logout', params, 'get')
  return result
}

// 轻松开店申请
export async function doApplyShops (params) {
  let result = await fetch('Api/h5/u/p/serviceContactApply/applysShops', params, 'get')
  return result
}

// 取货查看门店列表
export async function getShoplistByOrderId (params) {
  let result = await fetch('Api/h5/u/order/getShoplistByOrderId', params, 'get')
  return result
}
// 修改用户信息
export async function changeUserInfo (params) {
  let result = await fetch('/Api/h5/u/member/changeNickname', params, 'post')
  return result
}
// 删除搜索历史
export async function deleteUserSearcHis (params) {
  let result = await fetch('/Api/h5/u/search/deleteUserSearcHis', params, 'post')
  return result
}

// 分类商品列表
export async function getTypeGoodList (params) {
  let result = await fetch('Api/h5/m/p/actionTypeGoods', params, 'post')
  return result
}
